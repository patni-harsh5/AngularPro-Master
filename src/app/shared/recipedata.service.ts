...
export class RecipeData {
    private recipes: Recipe[] = [
        ...
        // new Recipe('Hammer', 'For hitting nails', 'https://images-na.ssl-images-amazon.com/images/I/61fnMMgkGIL._SX425_.jpg', new Date('09/25/2019'), new Date('10/25/2019') , 20, 200)
    ];
